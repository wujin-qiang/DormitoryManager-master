...
public class StudentCleanController {
     ...
     * pageSize  显示条数
     */
    @RequestMapping(value = "/findStudentCleanS")
    public String findDormCleanS(Integer s_studentid, String s_name, Integer s_dormitoryid, Integer pageIndex, Integer pageSize, Model model) {

        PageInfo<StudentClean> di = studentCleanService.findPageInfo(s_studentid,s_name,s_dormitoryid,pageIndex,pageSize);
        model.addAttribute("di",di);
        return "studentclean_listS";
    }
    /**
     * 导出Excel
     */
