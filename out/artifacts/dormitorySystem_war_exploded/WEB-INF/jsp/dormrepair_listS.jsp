...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/findDormRepairS" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findDormRepairS" >
        ...
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required" name="r_name"  class="layui-input" placeholder="请输入报修人员">
                    </div>
                </div>
            ...
            form.on('submit(toolbarDemo)', function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // 2. 数组头部新增表头
                        dt.unshift({r_id: 'ID', d_id: '宿舍编号', d_dormbuilding: '宿舍楼', r_name: '报修人员', reason: '报修事由', create_time: '报修时间',});
                ...
                form.on('submit(formDemo)', function(data) {
                    ...
                    $.ajax({
                        ...
                        success:function(){
                            ...
                            setTimeout(function () {window.location.href='/findDormRepairS';},2000);
