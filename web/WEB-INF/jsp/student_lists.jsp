...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="/findStudenttuS">学生信息</a>
      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/findStudenttuS" title="刷新">
    ...
    layui.use(['jquery', 'excel','form','layer','laydate'], function(){
        ...
        form.on('submit(toolbarDemo)', function(){
            ...
            $.ajax({
                ...
                error: function () {
                    //console.log(data);
                    setTimeout(function () {window.location.href='/findStudenttuS';},2000);
                }
            });
        });
